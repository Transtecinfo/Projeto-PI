 ...
 * @author 181720019
 */
public class U_ListLimpeza extends javax.swing.JInternalFrame {

     public JDesktopPane jdpTelaInicial;
     
    public U_ListLimpeza(JDesktopPane jdpPainel) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tableLimpeza.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        ...
        tableLimpeza.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableLimpezaMouseClicked(evt);
            }
        });
    ...
    private void tableLimpezaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableLimpezaMouseClicked
    ...
    }//GEN-LAST:event_tableLimpezaMouseClicked
    ...
    private void btnDoarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoarActionPerformed
        ...
        if(linha<0){
            ...
            int codigo = (int) tableLimpeza.getValueAt(linha,0);
            double max = (double) tableLimpeza.getValueAt(linha,7);
            double med = (double) tableLimpeza.getValueAt(linha,6);
            double min = (double) tableLimpeza.getValueAt(linha,5);
