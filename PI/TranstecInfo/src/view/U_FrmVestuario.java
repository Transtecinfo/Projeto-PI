 ...
 */
public class U_FrmVestuario extends javax.swing.JInternalFrame {
    ...
    public U_FrmVestuario(int codigo, ListVestuario telaListVestuario) {
    ...
    private void carregarFormulario() {
        ...
        if (vestuario.getSituacao().equals(vestuario.RUIM)) {
            rbRuim.setSelected(true);
        }

        if (vestuario.getSituacao().equals(vestuario.BOA)) {
            rbBoa.setSelected(true);
        }
        if (vestuario.getSituacao().equals(vestuario.OTIMA)) {
