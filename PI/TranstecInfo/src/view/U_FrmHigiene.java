 ...
 */
public class U_FrmHigiene extends javax.swing.JInternalFrame {
    ...
    public U_FrmHigiene(int codigo, ListHigiene telaListHigiene) {
    ...
    private void carregarFormulario() {
        ...
        if (higiene.getSituacao().equals(higiene.RUIM)) {
            rbRuim.setSelected(true);
        }

        if (higiene.getSituacao().equals(higiene.BOA)) {
            rbBoa.setSelected(true);
        }
        if (higiene.getSituacao().equals(higiene.OTIMA)) {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
       String nome = txtNome.getText();
        ...
        if (rbBoa.isSelected()) {
            higiene.setSituacao("b");
        } else {
            if (rbOtima.isSelected()) {
                higiene.setSituacao("O"); 
            } else if (rbRuim.isSelected()) {
                higiene.setSituacao("r");
            }
