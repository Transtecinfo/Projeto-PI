...
public class U_ListHigiene extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tableHigiene.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        ...
        tableHigiene.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableHigieneMouseClicked(evt);
            }
        });
    ...
    private void tableHigieneMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableHigieneMouseClicked
    ...
    }//GEN-LAST:event_tableHigieneMouseClicked
    ...
    private void btnDoarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoarActionPerformed
        ...
        if(linha<0){
            ...
            int codigo = (int) tableHigiene.getValueAt(linha,0);
            double max = (double) tableHigiene.getValueAt(linha,7);
            double med = (double) tableHigiene.getValueAt(linha,6);
            double min = (double) tableHigiene.getValueAt(linha,5);
